INSERT INTO Client (clientId, clientSecret, name) VALUES 
("d654d2fc-118b-8592-020a-f5b13c4eafbe", "clientSecret", "clientName");

INSERT INTO AllowRedirectUrl (id, clientId, url) VALUES 
("123e4567-e89b-12d3-a456-426614174000", "d654d2fc-118b-8592-020a-f5b13c4eafbe", "http://localhost:3000");

INSERT INTO Scope (id, clientId, name) VALUES 
